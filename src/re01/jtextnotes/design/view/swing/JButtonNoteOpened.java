 ...
 * @author renaud
 */
public class JButtonNoteOpened extends JButton {
	
	public JButtonNoteOpened() {
		super();
		construct();
	}
	
	public JButtonNoteOpened( String text ) {
		super( text );
		construct();
	}
	
	public JButtonNoteOpened( Icon icon ) {
		super( icon );
		construct();
	}
	
	public JButtonNoteOpened( String text, Icon icon ) {
		super( text, icon );
		construct();
	}
